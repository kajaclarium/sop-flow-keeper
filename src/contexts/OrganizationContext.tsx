...
const INITIAL_ROLES: OrgRole[] = [
  ...
  { id: "ROLE-0001", name: "Director of Operations", description: "Oversees all operational functions and strategic alignment", tierId: "strategic", raciType: "accountable", parentId: null, icon: "👤", sops: 12, raci: { R: "Strategy", A: "Everything", C: "Executive Team", I: "Board" }, createdAt: "2025-06-01" },
  { id: "ROLE-0002", name: "Facilities Director", description: "Leads all facility management, infrastructure, and capital planning", tierId: "strategic", raciType: "accountable", parentId: "ROLE-0001", icon: "🏢", sops: 8, raci: { R: "Facilities", A: "Director Ops", C: "Stakeholders", I: "All" }, createdAt: "2025-06-01" },
  { id: "ROLE-0003", name: "IT Director", description: "Drives IT strategy, cybersecurity, and digital infrastructure", tierId: "strategic", raciType: "accountable", parentId: "ROLE-0001", icon: "🛡️", sops: 15, raci: { R: "IT Strategy", A: "Director Ops", C: "Dept Heads", I: "All" }, createdAt: "2025-06-01" },

  /* Managerial tier — Consulted/Accountable roles that translate strategy to plans */
  { id: "ROLE-0004", name: "Senior Manager", description: "Manages cross-functional teams and departmental objectives", tierId: "managerial", raciType: "accountable", parentId: "ROLE-0001", icon: "📊", sops: 20, raci: { R: "Programs", A: "Director Ops", C: "Teams", I: "Dept" }, createdAt: "2025-06-01" },
  { id: "ROLE-0005", name: "Maintenance Manager", description: "Plans and oversees preventive and corrective maintenance programs", tierId: "managerial", departmentId: "DEP-0001", raciType: "accountable", parentId: "ROLE-0002", icon: "⚙️", sops: 30, raci: { R: "Ops", A: "Facilities Dir", C: "Techs", I: "Dept" }, createdAt: "2025-06-01" },
  { id: "ROLE-0006", name: "HR Manager", description: "Manages recruitment, onboarding, training, and employee relations", tierId: "managerial", departmentId: "DEP-0004", raciType: "accountable", parentId: "ROLE-0001", icon: "🤝", sops: 10, raci: { R: "HR Ops", A: "Director Ops", C: "Staff", I: "All" }, createdAt: "2025-06-01" },
  { id: "ROLE-HR01", name: "HR Specialist", description: "Handles employee relations, benefits administration, and policy compliance", tierId: "operational", departmentId: "DEP-0004", raciType: "responsible", parentId: "ROLE-0006", icon: "📋", sops: 5, raci: { R: "Benefits", A: "HR Manager", C: "Staff", I: "All" }, createdAt: "2025-06-01" },
  { id: "ROLE-HR02", name: "Recruiter", description: "Manages end-to-end recruitment process and talent acquisition", tierId: "operational", departmentId: "DEP-0004", raciType: "responsible", parentId: "ROLE-0006", icon: "🔍", sops: 4, raci: { R: "Hiring", A: "HR Manager", C: "Dept Heads", I: "Talent" }, createdAt: "2025-06-01" },
  { id: "ROLE-HR03", name: "Payroll Coordinator", description: "Ensures accurate and timely payroll processing and tax compliance", tierId: "operational", departmentId: "DEP-0004", raciType: "responsible", parentId: "ROLE-0006", icon: "💰", sops: 6, raci: { R: "Payroll", A: "HR Manager", C: "Finance", I: "Staff" }, createdAt: "2025-06-01" },
  { id: "ROLE-0007", name: "Compliance Lead", description: "Ensures regulatory compliance and coordinates audits", tierId: "managerial", departmentId: "DEP-0003", raciType: "consulted", parentId: "ROLE-0001", icon: "📜", sops: 25, raci: { R: "Audits", A: "Director Ops", C: "Legal", I: "Dept" }, createdAt: "2025-06-01" },
  { id: "ROLE-0008", name: "QC Lead", description: "Leads quality control processes and inspection standards", tierId: "managerial", departmentId: "DEP-0003", raciType: "accountable", parentId: "ROLE-0003", icon: "✅", sops: 18, raci: { R: "Quality", A: "IT Dir", C: "Labs", I: "Sales" }, createdAt: "2025-06-01" },
  { id: "ROLE-0009", name: "Logistics Coordinator", description: "Coordinates inbound/outbound logistics and warehouse operations", tierId: "managerial", departmentId: "DEP-0001", raciType: "consulted", parentId: "ROLE-0005", icon: "🚚", sops: 12, raci: { R: "Freight", A: "Maint Boss", C: "Drivers", I: "Purchasing" }, createdAt: "2025-06-01" },
  { id: "ROLE-0010", name: "IT Manager", description: "Manages day-to-day IT operations and help desk", tierId: "managerial", departmentId: "DEP-0002", raciType: "accountable", parentId: "ROLE-0003", icon: "💻", sops: 22, raci: { R: "IT Help", A: "IT Dir", C: "Users", I: "Dept" }, createdAt: "2025-06-01" },

  /* Operational tier — Responsible roles that execute daily work */
  { id: "ROLE-0011", name: "Maintenance Technician", description: "Performs hands-on preventive and corrective maintenance tasks", tierId: "operational", departmentId: "DEP-0001", raciType: "responsible", parentId: "ROLE-0005", icon: "🛠️", sops: 5, raci: { R: "Repairs", A: "Maint Mgr", C: "Custodial", I: "Users" }, createdAt: "2025-06-01" },
  { id: "ROLE-0012", name: "Senior Technician", description: "Handles complex repairs and mentors junior technicians", tierId: "operational", departmentId: "DEP-0001", raciType: "responsible", parentId: "ROLE-0005", icon: "🔌", sops: 7, raci: { R: "Expertise", A: "Maint Mgr", C: "Techs", I: "Users" }, createdAt: "2025-06-01" },
  { id: "ROLE-0013", name: "Facility Supervisor", description: "Supervises daily facility cleaning and hygiene operations", tierId: "operational", departmentId: "DEP-0001", raciType: "responsible", parentId: "ROLE-0005", icon: "🧹", sops: 15, raci: { R: "Cleaning", A: "Maint Mgr", C: "Staff", I: "Users" }, createdAt: "2025-06-01" },
  { id: "ROLE-0014", name: "QC Inspector", description: "Inspects incoming materials and in-process quality checks", tierId: "operational", departmentId: "DEP-0003", raciType: "responsible", parentId: "ROLE-0008", icon: "🔍", sops: 3, raci: { R: "Inspections", A: "QC Lead", C: "Production", I: "Admin" }, createdAt: "2025-06-01" },
  { id: "ROLE-0015", name: "HSE Officer", description: "Implements workplace safety protocols and incident response", tierId: "operational", departmentId: "DEP-0003", raciType: "responsible", parentId: "ROLE-0007", icon: "🦺", sops: 40, raci: { R: "Safety", A: "Compliance", C: "All", I: "Admin" }, createdAt: "2025-06-01" },
  { id: "ROLE-0016", name: "System Administrator", description: "Manages system backups, server administration, and disaster recovery", tierId: "operational", departmentId: "DEP-0002", raciType: "responsible", parentId: "ROLE-0010", icon: "⚙️", sops: 50, raci: { R: "Servers", A: "IT Mgr", C: "Devs", I: "Users" }, createdAt: "2025-06-01" },
];
