  ...
  return (
    <div className="flex-1 overflow-y-auto">
      <div className="max-w-4xl mx-auto px-6 py-6 space-y-6">
        {/* Back Button */}
        <Button variant="ghost" size="sm" className="gap-1.5 -ml-2" onClick={() => navigateToTasks(task.moduleId)}>
        ...
        {controlStatus === "Uncontrolled" && (
          <div className="flex items-start gap-3 rounded-xl border border-red-200 bg-red-50/50 p-4">
            ...
            <div>
              <p className="text-sm font-medium text-red-800">No Active SOP Linked</p>
